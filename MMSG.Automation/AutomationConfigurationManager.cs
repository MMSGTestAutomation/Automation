...
namespace MMSG.Automation
{
    public class AutomationConfigurationManager
    {
        ...
        public static string GetApplicationUrltRoot()
        {
            ...
            {
                case "COMET":
                    productURL = AutomationConfigurationManagerResource.COMET_URL;
                    applicationUrl = string.Format(productURL, appServerName);
                    break;
                ...
                case "ROL":
                    productURL = AutomationConfigurationManagerResource.ROL_URL;
                    applicationUrl = string.Format(productURL, environment);
                    break;
