    ...
    public class Logger
    {
        ...
        private void TakeScreenShot(string fileName)
        {
            try
            {
                ...
                //string executingPath = Directory.GetParent(Directory.GetCurrentDirectory()).FullName +
                //    AutomationConfigurationManagerResource.Output_Path;
            ...
            catch (Exception e)
            {
                ...
                new CustomReport().AddStatusToReport
                     (CustomReport.ReportStatus.Fatal, "Unable to take screenshot" + e);
            }
        }
