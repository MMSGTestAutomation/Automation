...
namespace MMSG.Acceptance.Comet.Tests.ProductAcceptanceTestDefinition
{
    ...
    public class CustomReportWriter
    {
        ...
        {
            new CustomReport().
            AddStatusToReport(MMSG.Automation.CustomReport.ReportStatus.Info,
        ...
        public static void AfterScenario()
        {
            ...
            if (status == null)
            {
                ...
                if (executionStatus.Equals("OK"))
                {
                    ...
                    (MMSG.Automation.CustomReport.ReportStatus.Pass,
                ...
                {
                    new CustomReport().AddStatusToReport
                    (MMSG.Automation.CustomReport.ReportStatus.Warning,
            ...
            {
                new CustomReport().AddStatusToReport
                (MMSG.Automation.CustomReport.ReportStatus.Error, "<font color='red'>Scenario Failed</font>"
                + ScenarioContext.Current.ScenarioInfo.Title.ToString());
            }
        }
        ...
        public static void AfterStep()
        {
            ...
            if (status != null)
            {
                ...
                new CustomReport().AddStatusToReport
               (MMSG.Automation.CustomReport.ReportStatus.Error, "<b><font color='red'>Failed</font></b> ->" + step.ToString() +
               "|<b> Reason</b> :-" + messageToLog);
                //atach innerException
                var innerException = status.InnerException;
                var customMessage = ExceptionHandler.GetCustomExceptionMessage(innerException);
                if (innerException != null && !string.IsNullOrWhiteSpace(customMessage))
                {
                    new CustomReport().AddStatusToReport
                  (MMSG.Automation.CustomReport.ReportStatus.Error, "<b><font color='red'>InnerExeption</font></b> ->"
                ...
                {
                    new CustomReport().AddStatusToReport
                    (MMSG.Automation.CustomReport.ReportStatus.Error, "<b><font color='red'>StackTrace</font></b> ->"
                    + "<textarea class='code-block'>" +
